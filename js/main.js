...
$(function ($) {
   ...
   $("#about-click").on('click', function () {
      $("body,html").animate(
            {
              scrollTop: $("#tw-mission").offset().top-100
            },
            1000 //speed
          );
   });
   ...
   $("#services-click").on('click', function () {
      $("body,html").animate(
            {
              scrollTop: $("#tw-features").offset().top-100
            },
            1000 //speed
          );
   });
   $("#quality-click").on('click', function () {
      $("body,html").animate(
            {
              scrollTop: $("#tw-facts").offset().top-100
            },
            1000 //speed
          );
   });

   $("#facts-click").on('click', function () {
      $("body,html").animate(
            {
